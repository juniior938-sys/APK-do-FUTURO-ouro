...
export const SUPPORTED_SYMBOLS: Record<string, SymbolSpec> = {
  'XAUUSD.pc': {
    symbol: 'XAUUSD.pc',
    name: 'Gold (UltimaMarkets Live 2)',
    category: 'metals',
    basePrice: 4258.46,
    decimals: 2,
    pipSize: 0.10,
    ...
    description: 'XAUUSD.pc na escala vertical do MT5 com Target Go Money.',
    icon: '🥇',
  },
  XAUUSD: {
    symbol: 'XAUUSD',
  ...
  AUDUSD: {
    ...
    lotStep: 0.01,
    typicalSpreadPips: 0.3,
    description: 'Par de commodities com forte correlação com minério e ouro.',
    icon: '🦘',
  },
  USDCAD: {
    symbol: 'USDCAD',
    ...
    description: 'Conhecido como Loonie, influenciado pelos preços do Petróleo WTI.',
    icon: '🍁',
  },
  USDCHF: {
    symbol: 'USDCHF',
    ...
    lotStep: 0.01,
    typicalSpreadPips: 0.4,
    description: 'Ativo de refúgio cambial seguro (Safe Haven) na Europa.',
    icon: '🇨🇭',
  },
  EURGBP: {
    symbol: 'EURGBP',
    ...
    lotStep: 0.01,
    typicalSpreadPips: 0.3,
    description: 'Cross europeu clássico, ideal para scalping em range controlado.',
    icon: '🏛️',
  },
  GBPJPY: {
    symbol: 'GBPJPY',
    name: 'Libra Esterlina / Iene Japonês',
    category: 'forex',
    basePrice: 197.850,
    decimals: 3,
    pipSize: 0.010,
